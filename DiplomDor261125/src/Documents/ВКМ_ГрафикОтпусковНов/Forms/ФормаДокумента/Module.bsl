...
Процедура АнализГрафика(Команда)
    ...
    ОткрытьФорму("Документ.ВКМ_ГрафикОтпусковНов.Форма.АнализГрафикаНов", ПараметрыФормы);
...
Функция ПоместитьВоВременноеХранилищеНаСервере() Экспорт
	 ...
	 ОтпускаСотрудниковДанные = Объект.ОтпускаСотрудников.Выгрузить();
     Адрес = ПоместитьВоВременноеХранилище(ОтпускаСотрудниковДанные); 
     Возврат Адрес; 
